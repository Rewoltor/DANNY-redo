            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="leading-relaxed" style={{ color: colors.text, opacity: 0.8 }}>
                  Egy rövid intelligenciatesztet fogsz kitölteni, amely logikai gondolkodást,
                  mintafelismerést és problémamegoldást mér. Ne aggódj – a feladatok nehezednek, de
                  senki sem oldja meg mindet.
                </p>
              </div>
            </div>
          </div>
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="leading-relaxed" style={{ color: colors.text, opacity: 0.8 }}>
                  A kutatás azt vizsgálja, hogy a kognitív képességek befolyásolják-e a tanulási
                  sebességet és a teljesítményt a radiológiai feladatban. Az eredmények segítenek
                  megérteni, hogyan lehet optimalizálni az AI-asszisztált képértékelést.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="flex-1">
                ...
                <ul className="space-y-2" style={{ color: '#78350f' }}>
                  <li className="flex items-start gap-3">
                    ...
                    <span>Dolgozz csendben, használj papírt és ceruzát számoláshoz</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <svg
                      className="w-5 h-5 flex-shrink-0 mt-0.5"
                    ...
                    <span>Ne használj számológépet vagy internetet</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <svg
                      className="w-5 h-5 flex-shrink-0 mt-0.5"
                    ...
                    <span>Nem baj, ha nem tudsz minden feladatot megoldani</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <svg
                      className="w-5 h-5 flex-shrink-0 mt-0.5"
                    ...
                    <span>
                      Koncentrálj, de ne stresszelj – add meg a legtöbbet, amire képes vagy
                    </span>
                  </li>
                </ul>
              </div>
